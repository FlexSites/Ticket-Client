...
const db = require('@nerdsauce/mongo').get('venue', { castIds: false })
...
const authzRemove = any.bind(any, ['remove:venues'])
const authzCreate = any.bind(any, ['create:venues'])
const authzUpdate = any.bind(any, ['update:venues'])
