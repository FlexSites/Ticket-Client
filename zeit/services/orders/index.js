...
const db = require('@nerdsauce/mongo').get('order', { castIds: false })
...
const authzRemove = any.bind(any, ['remove:orders'])
const authzCreate = any.bind(any, ['create:orders'])
const authzUpdate = any.bind(any, ['update:orders'])
